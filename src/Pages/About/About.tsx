  ...
  return (
    <div className={styles.about} id="about">
      ...
      <p className={styles.par}>
        I create reliable, maintainable web applications using modern tools and
        best practices. Whether independently or in a team, I’m always ready to
        create something amazing.
      </p>
      <a
        href="https://drive.google.com/file/d/1jNJyaS5wSr9_ZQVUz8-EW1Ca5VXvrGfS/view?usp=sharing"
        target="_blank"
